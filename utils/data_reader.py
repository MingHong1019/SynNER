...
if __name__ == '__main__':
    ...
    train_sentence, train_span, train_label, train_type = ace05_chinese(path, grained='fine')

    # path = '../../data/ACE2005'
    # train_sentence, train_span, train_label, train_type = ace05(path, grained='fine')
